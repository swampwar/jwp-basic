...
public class LegacyHandlerMapping implements HandlerMapping{
    ...
    void initMapping() {
        ...
        mappings.put("/", new HomeController(qnaService));
...
//        mappings.put("/users/create", new CreateUserController());
        ...
        mappings.put("/qna/show", new ShowQuestionController(qnaService));
        mappings.put("/qna/form", new CreateFormQuestionController());
        mappings.put("/qna/create", new CreateQuestionController(qnaService));
        mappings.put("/qna/updateForm", new UpdateFormQuestionController(qnaService));
        mappings.put("/qna/update", new UpdateQuestionController(qnaService));
        ...
        mappings.put("/api/qna/list", new ApiListQuestionController(qnaService));
        mappings.put("/api/qna/addAnswer", new AddAnswerController(qnaService));
        mappings.put("/api/qna/deleteAnswer", new DeleteAnswerController(qnaService));
